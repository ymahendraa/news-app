...
const TechPost = ({ index, article }: { index: number, article: Article }) => {
  return (
    <Space direction="horizontal" className={style.container} size="middle" align={index == 0 ? "center" : "baseline"}>
      {
        index == 0 ?
          <Img src={article.urlToImage} /> : <GoDotFill size={15} color="#5842FF" />
      }
