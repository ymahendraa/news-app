...
const MainPage: React.FC = () => {
  ...
  if (isLoadingMain || isLoadingTech || isLoadingHealth || isLoadingTrending)
    return <div>Loading...</div>;

  if (errorMain || errorHealth || errorTech || errorTrending)
    ...
    <Row>
      ...
      <Col xs={24} lg={7}>
        <Space
          direction="vertical"
          size="large"
          className={styles["mini-section-container"]}
        >
          <Row>
            <Text
              style={{
